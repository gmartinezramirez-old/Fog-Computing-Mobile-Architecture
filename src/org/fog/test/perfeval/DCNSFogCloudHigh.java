...
public class DCNSFogCloudHigh {
	...
	public static void main(String[] args) {
		...
		Log.printLine("Starting application...");
		...
		try {
			...
			*/
			...
			Log.printLine("Finish application");
		} catch (Exception e) {
			e.printStackTrace();
	...
	private static FogDevice addArea(String id, int userId, String appId, int parentId){
		FogDevice router = createFogDevice("d-"+id, 1600, 512, 10000, 10000, 1, 0.0, 82.777, 82.7);
	...
	// Mobile devices
	// High: MIPS: 2.3 Ghz. RAM: 4 GB. BUSYPWR: 99.45 IDLEPWR: 83.10
	// Medium: MIPS: 2.0 Ghz. RAM: 2 GB. BUSYPWR: 95.5 IDLEPWR: 82.95
	// Low: MIPS: 1 Ghz. RAM: 1 GB. BUSYPWR: 82.77 IDLEPWR: 82.7
	// NOW: Low
